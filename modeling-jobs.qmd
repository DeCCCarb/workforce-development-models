...
pv_all_plot1 <- ggplot(pv_v_plot) +
    theme_minimal() +
    geom_bar(aes(x = year, y = n_jobs, color = occupation), size = 1.25, position = "stack", stat="identity")+
...
ggsave('pv_base_plot.png', pv_all_plot1, width = 8, height = 6)
...
ggsave('pv_capacity_growth_plot_V.png', pv_capacity_growth_plot_V, width = 8, height = 6)
#pv_cap_plot
```
...
ggsave('pv_u_v_plot.png', pv_u_v_plot, width = 10, height = 7)
```
...
ggsave('pv_u_sb_plot.png', pv_all_plot1, width = 8, height = 6)
```
...
ggsave('pv_u_slo_plot.png', pv_all_plot1, width = 8, height = 6)
```
